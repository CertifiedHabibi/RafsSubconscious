...
app.get("/", (req, res) => res.send("Raf's Subconscious has awakened..."));
app.listen(3000, () => console.log("Web server of the bot is live"));
...
client.once("ready", async () => {
  console.log(`${client.user.tag} is online in the server!`);
